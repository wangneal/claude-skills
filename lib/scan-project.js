...
module.exports = {
  scanProject,
  DomainIdentifier: require('../../engine/lib/project-scanner.js').DomainIdentifier,
  DomainEntityExtractor: require('../../engine/lib/project-scanner.js').DomainEntityExtractor
};
